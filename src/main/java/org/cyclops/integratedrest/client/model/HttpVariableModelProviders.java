...
public class HttpVariableModelProviders {
    ...
    public static final SingleVariableModelProvider HTTP = REGISTRY.addProvider(new SingleVariableModelProvider(Identifier.fromNamespaceAndPath(Reference.MOD_ID, "customoverlay/http")));
